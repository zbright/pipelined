...
add wave -noupdate -group IF_ID /system_tb/DUT/CPU/DP/IFID/stall
...
add wave -noupdate -group IF_ID /system_tb/DUT/CPU/DP/IFID/temp_NPC_output
add wave -noupdate -group IF_ID /system_tb/DUT/CPU/DP/IFID/temp_imemload_output
