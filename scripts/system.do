...
add wave -noupdate -expand -group {dcache 1} -subitemconfig {{/system_tb/DUT/CPU/CM1/DCACHE/cacheblock_one[4]} -expand} /system_tb/DUT/CPU/CM1/DCACHE/cacheblock_one
...
update
WaveRestoreZoom {833001 ps} {998136 ps}
